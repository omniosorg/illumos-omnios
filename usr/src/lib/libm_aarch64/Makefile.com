...
OBJECTS= b_tgamma.o \
	e_acos.o e_acosf.o e_acosh.o e_acoshf.o e_asin.o e_asinf.o s_cospi.o \
...
OBJECTS_LD128 += 	catrigl.o \
	...
	s_scalbnl.o s_sinl.o s_sincosl.o s_cexpl.o \
...
OBJECTS +=	s_fabs.o s_ldexp.o s_modf.o isinf.o
...
CPPFLAGS.first = -I$(MSUN_BASE)/src

CERRWARN += -_gcc=-fno-builtin
...
# XXXARM: We're using parts of the BSD headers, so we have to tell them to
# expose things.
