...
/*
 * This is largely a copy of usr/src/uts/common/io/kb8042/kb8042_keytables.c
 * as the Hyper-V virtual keyboard appears to emulate a PS/2 keyboard.
 * However, since there is no documentation for this, we err on the side
 * of caution and assume it may not emulate it fully. As such, having its
 * own keymap should allow for dealing with any divergence or additional
 * keys found in the Hyper-V keyboard but not on the original PS/2 keyboard.
 */
...
/* BEGIN CSTYLED */
static keymap_entry_t keytab_hvkbd_lc[KEYMAP_SIZE_PC] = {
/*  0 */	HOLE,	'`',	'1',	'2',	'3',	'4',	'5',	'6',
/*  8 */	'7',	'8',	'9',	'0',	'-',	'=',	HOLE,	'\b',
/* 16 */	'\t',	'q',	'w',	'e',	'r',	't',	'y',	'u',
/* 24 */	'i',	'o',	'p',	'[',	']',	'\\',
...
static keymap_entry_t keytab_hvkbd_uc[KEYMAP_SIZE_PC] = {
/*  0 */	HOLE,	'~',	'!',	'@',	'#',	'$',	'%',	'^',
/*  8 */	'&',	'*',	'(',	')',	'_',	'+',	HOLE,	'\b',
/* 16 */	'\t',	'Q',	'W',	'E',	'R',	'T',	'Y',	'U',
/* 24 */	'I',	'O',	'P',	'{',	'}',	'|',
...
/* Caps Locked keyboard table */
static keymap_entry_t keytab_hvkbd_cl[KEYMAP_SIZE_PC] = {
/*  0 */	HOLE,	'`',	'1',	'2',	'3',	'4',	'5',	'6',
/*  8 */	'7',	'8',	'9',	'0',	'-',	'=',	HOLE,	'\b',
/* 16 */	'\t',	'Q',	'W',	'E',	'R',	'T',	'Y',	'U',
/* 24 */	'I',	'O',	'P',	'[',	']',	'\\',
...
/* Alt Graph keyboard table */
static keymap_entry_t keytab_hvkbd_ag[KEYMAP_SIZE_PC] = {
...
/* Num Locked keyboard table */
static keymap_entry_t keytab_hvkbd_nl[KEYMAP_SIZE_PC] = {
...
/* Controlled keyboard table */
static keymap_entry_t keytab_hvkbd_ct[KEYMAP_SIZE_PC] = {
...
/* "Key Up" keyboard table */
static keymap_entry_t keytab_hvkbd_up[KEYMAP_SIZE_PC] = {
/*  0 */	HOLE,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,
/*  8 */	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	HOLE,	NOP,
/* 16 */	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,
...
struct keyboard keyindex_hvkbd = {
	KEYMAP_SIZE_PC,
	keytab_hvkbd_lc,
	keytab_hvkbd_uc,
	keytab_hvkbd_cl,
