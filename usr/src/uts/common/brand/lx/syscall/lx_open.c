...
ltos_open_flags(int input)
{
	 ...
	 * device backing the fd in question.  illumos doesn't have exactly the
	 * same functionality, but we can attempt to simulate it using the
	 * flags (O_DIRECT|O_RSYNC|O_SYNC).
	 *
