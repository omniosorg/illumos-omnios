 ...
 * MMIO TRANSPORT
 *
 * MMIO transport register offsets (version 1, legacy-equivalent).
 */
#define	VIRTIO_MMIO_MAGIC_VALUE		0x000	/* 32 R   */
#define	VIRTIO_MMIO_VERSION		0x004	/* 32 R   */
#define	VIRTIO_MMIO_DEVICE_ID		0x008	/* 32 R   */
#define	VIRTIO_MMIO_VENDOR_ID		0x00c	/* 32 R   */
#define	VIRTIO_MMIO_HOST_FEATURES	0x010	/* 32 R   */
#define	VIRTIO_MMIO_HOST_FEATURES_SEL	0x014	/* 32 W   */
#define	VIRTIO_MMIO_GUEST_FEATURES	0x020	/* 32 W   */
#define	VIRTIO_MMIO_GUEST_FEATURES_SEL	0x024	/* 32 W   */
#define	VIRTIO_MMIO_GUEST_PAGE_SIZE	0x028	/* 32 W   */
#define	VIRTIO_MMIO_QUEUE_SEL		0x030	/* 32 W   */
#define	VIRTIO_MMIO_QUEUE_NUM_MAX	0x034	/* 32 R   */
#define	VIRTIO_MMIO_QUEUE_NUM		0x038	/* 32 W   */
#define	VIRTIO_MMIO_QUEUE_ALIGN		0x03c	/* 32 W   */
#define	VIRTIO_MMIO_QUEUE_PFN		0x040	/* 32 R/W */
#define	VIRTIO_MMIO_QUEUE_NOTIFY	0x050	/* 32 W   */
#define	VIRTIO_MMIO_INTERRUPT_STATUS	0x060	/* 32 R   */
#define	VIRTIO_MMIO_INTERRUPT_ACK	0x064	/* 32 W   */
#define	VIRTIO_MMIO_STATUS		0x070	/* 32 R/W */
#define	VIRTIO_MMIO_CONFIG		0x100

#define	VIRTIO_MMIO_MAGIC		0x74726976	/* "virt" */

/*
 * Property name indicating that we should use the MMIO transport.
 * This property simply needs to exist (it is treated as boolean).
 */
#define	VIRTIO_MMIO_PROPERTY_NAME	"virtio-is-mmio"

/*
 * For MMIO v1 devices, virtqueues are aligned on 64 bytes and queue
 * size is capped at the device's maximum, which we limit to 1024.
 */
#define	MMIO_VQ_ALIGN			64
#define	MMIO_VQ_MAX			1024
